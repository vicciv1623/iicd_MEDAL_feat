...
class RelevancePropagationSELU(nn.Module):
    """Layer-wise relevance propagation for SeLU activation.

    Passes the relevance scores without modification. Might be of use later.

    """

    def __init__(self, layer: torch.nn.SELU, top_k: float = 0.0) -> None:
        super().__init__()
